      ...
      <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-900">
        ...
        >
          <div className="px-3 py-4 sm:px-6 lg:px-8 lg:py-8">
            ...
            {/* Welcome Section */}
            <div className="mb-6 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 p-4 text-white sm:mb-8 sm:p-8">
            ...
            {/* Search Section */}
            <div className="rounded-lg bg-white p-4 shadow dark:bg-zinc-800 sm:p-6">
              <h3 className="mb-4 text-base font-semibold text-black dark:text-zinc-50 sm:text-lg">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <input
                  ...
                  className="min-h-[44px] flex-1 rounded-lg border border-zinc-300 px-4 py-2 text-black focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-zinc-600 dark:bg-zinc-700 dark:text-zinc-50"
                />
                <button className="min-h-[44px] rounded-lg bg-blue-600 px-6 py-2 font-medium text-white transition-colors hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
                  Search
                </button>
              </div>
            </div>
